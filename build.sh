...
function install_main {
    echo "from rsl import legacy_cli" >  $1/__main__.py
    echo "legacy_cli.main()"          >> $1/__main__.py
}
...
make_executable $TEMP_DIR/inst $CURR_DIR/gen_erate || exit 1

echo ""
echo "Executable successfully created"
echo ""
echo "    $CURR_DIR/gen_erate"
